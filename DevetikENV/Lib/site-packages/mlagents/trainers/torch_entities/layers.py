...
def lstm_layer(
    ...
    """
    print("LSTM VVVVVVVVVVVVVVV ",input_size)
...
class LinearEncoder(torch.nn.Module):
    ...
    def __init__(
        ...
        print("YYYYYYY ", 0, " YYYYYYYYYYY", hidden_size)
        dropout_rate = 0.5  # Taux de dropout de 50%
        for _ in range(num_layers - 1):
            print("YYYYYYY ", _+1, " YYYYYYYYYYY", hidden_size)
            self.layers.append(
                linear_layer(
                    hidden_size,
                    hidden_size,
