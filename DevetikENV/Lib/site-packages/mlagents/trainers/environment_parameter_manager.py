...
class EnvironmentParameterManager:
    ...
    def log_current_lesson(self, parameter_name: Optional[str] = None) -> None:
        ...
        if parameter_name is not None:
            ...
            os.environ['CURRENT_CURRICULUM_STEP'] = str(lesson_name)
            with open('C:/Dev/Unity_ML-Agents/V3/ELMO/curriculum_step.txt', 'w') as file:
                file.write(str(lesson_name))
            lesson_value = settings.curriculum[lesson_number].value
            logger.info(
                f"XXXXXXX Set ICI la variable d'environnement XXXXXXXXX Parameter '{parameter_name}' is in lesson '{lesson_name}' "
            ...
            for parameter_name, settings in self._dict_settings.items():
                ...
                with open('C:/Dev/Unity_ML-Agents/V3/ELMO/curriculum_step.txt', 'w') as file:
                    file.write(str(lesson_name))
                logger.info(
                    f"YYYYYYYYYYYYY Parameter '{parameter_name}' is in lesson '{lesson_name}' "
                    f"and has value '{lesson_value}'."
                )
